...
def train_step(model,
    ...
    with tf.GradientTape() as tape:
        ...
        loc_loss, conf_loss, mask_loss, seg_loss, total_loss = loss_fn(output, labels, 11)
...
def main(argv):
    ...
    optimizer = tf.keras.optimizers.SGD(learning_rate=lr_schedule, momentum=FLAGS.momentum, nesterov=True)
